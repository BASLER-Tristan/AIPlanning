...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/tristan.basler/planauto.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/tristan.basler/planauto/-/settings/integrations)
